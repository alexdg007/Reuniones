...
from App.models import Lugar, Reuniones, Tema, TipoReunion, EstadoReunion, EstadoTarea, temasdos, asistentes
...
class temasdosp(admin.StackedInline, SortableInline):    
    model = temasdos
    fields = ('nombre', 'Contenido', 'Acuerdos', 'tema_padre', 'tema_padre_dos')
    extra = 0
...
class FormularioReuniones(admin.ModelAdmin):
    form = RegisReuniones   
    inlines = [
        MembershipInline, temasdosp, asistentesreunion,
    ]
    #exclude = ('idTema',)
    fieldsets = (
