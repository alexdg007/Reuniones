...
class Reuniones(models.Model):
	...
	tiempo_estimado = models.IntegerField(max_length=1, null=True, choices=CANTIDADHORAS, help_text='Numero de Horas')
...
class temasdos(models.Model):
	...
	tema_padre_dos = models.ForeignKey('self', null=True, blank=True)
